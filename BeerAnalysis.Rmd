...
```{r}
# Prepare data for knn modeling to predict style based off of ABV and IBU
...
#TODO: Figure out how to change any style containing "IPA" to type "IPA"
...
# Name: "Average Beer"
# Calculate the mean ABV/IBU and the mode for ounces/style/state and assign it to the "Average Beer"
```